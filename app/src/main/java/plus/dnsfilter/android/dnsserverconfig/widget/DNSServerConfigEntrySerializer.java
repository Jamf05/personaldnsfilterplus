package plus.dnsfilter.android.dnsserverconfig.widget;

import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigBaseEntry.CHAR_LINE_COMMENTED;
import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry.CHAR_ENTRY_INACTIVE;
import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry.EMPTY_STRING;
import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry.ENTRY_PARTS_SEPARATOR;
import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry.IP_END_BRACER;
import static plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry.IP_START_BRACER;

import plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigBaseEntry;
import plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigCommentedEntry;
import plus.dnsfilter.android.dnsserverconfig.widget.listitem.DNSServerConfigEntry;
